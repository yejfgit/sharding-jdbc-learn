...
public class EncryptionUtil {
	 ...
	 * @date 2008-10-8
	 */
	private static byte[] coderByDES(byte[] plainText, String key, int mode) throws InvalidKeyException,
	...
	public static void main(String[] args) {
		...
		String aft = encoderByDES(text, key);
		long lUseTime = System.currentTimeMillis() - lStart;
		System.out.println("加密耗时：" + lUseTime + "毫秒");
		
		System.out.println(aft);

		String pre = decoderByDES(aft, key);
