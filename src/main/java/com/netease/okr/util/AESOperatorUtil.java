...
public class AESOperatorUtil {
	 ...
	 */
	// a0b891c2d563e4f7
	private String sKey = ConstantsUtil.SKEY;
	private String ivParameter = ConstantsUtil.IV_PARAMETER;
	...
	public static void main(String[] args) {
		...
		System.out.println("加密耗时：" + lUseTime + "毫秒"); // 解密 
		...
		String salary = "15000";
		String enString = AESOperatorUtil.getInstance().encrypt(salary);
		System.out.println("加密后的字串是：" + enString);
		System.out.println("长度为" + enString.length());

		String DeString = AESOperatorUtil.getInstance().decrypt("90bgle00vREHJvccLBKwsA==");
		System.out.println("解密后的字串是：" + DeString);
